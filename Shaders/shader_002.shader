...
void main()
{
    ...
    NormalBuffer = vec4(fs_in.normal, 1.0);//vec4(normalize(fs_in.TBN * normal), 1.0);
    ColorBuffer = vec4(1.0);//texture(Albedo, fs_in.TexCoords);
	DataBuffer = vec4(0.0, 0.2, 1.0, 1.0);
}
###END_FRAGMENT###