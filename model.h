...
//#include "../models/box.hpp" ---> look up the code at some point, mayb neds to take som components to get this work
...
#include "Bounds.h"
#include <Mesh.h>
#include "Engine/external/assimp/code/BlenderLoader.h"
#include "Engine/external/assimp/code/ObjFileData.h"
